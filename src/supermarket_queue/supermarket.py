...
def queue_time(customers, n):
    ...
    elapsed_time = 0
    till = [None
#     while loop w/ condition that things in 'checkout' not < n.  when time remaining
#     for customer = 0, remove from 'checkout'.
#
    while len(customers):

#     when queueueueueue is empty and 'checkout' is empty, be freeeeeee!
